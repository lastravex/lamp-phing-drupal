 ...
 *
 */
$drupal_hash_salt = 'LdcQi9rm3upmHiGBP5GwV7QorAQs7tWEgSHJi6d3Fns';
...
// Include Acquia Cloud per-environment database config.
if (file_exists("/var/www/site-php/${remote.project.name}")) {
  require("/var/www/site-php/${remote.project.name}/${remote.project.name}-settings.inc");
}
...
$settings_file = DRUPAL_ROOT . "/sites/all/config/settings.{$env}.php";
